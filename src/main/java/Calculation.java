    ...
    public  String findCheapRefill (Cities city){
        ...
        if (minForwardway < minBackwardWay){
            ...
            if (city.getID() == counter){
                ...
                resultMessage = "Жителям города " + city.getNameOfCity() + " дешевле заправиться в своем городе по цене: " + minForwardway;
            }
            else {
                ...
                resultMessage = "Жителям города " + city.getNameOfCity() + " дешевле заправиться в городе " + Cities.values()[counter].getNameOfCity() + " По цене: " + minForwardway + " в прямом направлении ";
            }
        }
            ...
            if (city.getID() == counter){
                ...
                resultMessage = "Жителям города " + city.getNameOfCity() + " дешевле заправиться в городе " + Cities.values()[counter].getNameOfCity() + " По цене: " + minForwardway + " в любом направлении ";
            }
        }
        else {
            int counter = 0;
            ...
            if (city.getID() == counter){
                ...
                resultMessage = "Жителям города " + city.getNameOfCity() + " дешевле заправиться в своем городе по цене: " + minBackwardWay;
            }
            else {
                ...
                resultMessage = "Жителям города " + city.getNameOfCity() + " дешевле заправиться в городе " + Cities.values()[counter].getNameOfCity() + " По цене: " + minBackwardWay + " в обратном направлении ";
            }
        }
